	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th class="sort-column dispute_time" style="text-align:center;">受理时间</th>
				...
				<th class="sort-column report_emp" style="text-align:center;">调解次数</th>
				<th class="sort-column r.patient_mobile" style="text-align:center;">涉及核心制度</th>
				<th class="sort-column a.agreement_number" style="text-align:center;">反馈函编号</th>
				<th class="sort-column a.ratify_accord" style="text-align:center;">协议签署时间</th>
				<th class="sort-column a.ratify_accord" style="text-align:center;">协议编号</th>
				...
				<th class="sort-column a.ratify_accord" style="text-align:center;">医院赔付金额</th>
				<th class="sort-column a.ratify_accord" style="text-align:center;">是否司法确认</th>
				<th class="sort-column a.compensate_time" style="text-align:center;">是否重大</th>
				<th class="sort-column a.compensate_time" style="text-align:center;">是否媒体介入</th>
				<th class="sort-column a.create_date" style="text-align:center;">部门名称</th>
				<th class="sort-column a.update_date" style="text-align:center;">调解员</th>
