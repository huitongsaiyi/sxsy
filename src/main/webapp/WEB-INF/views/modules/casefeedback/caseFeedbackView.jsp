...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            //案件评价
            $("#ajpjDetail").attr("src","${ctx}/assessinfo/assessInfo/form?id=${map.ajpj}&type=view&show2=y");
            var ajpj= document.getElementById("ajpjDetail");
            ajpj.height=document.documentElement.clientHeight-130;
            ajpj.width=document.documentElement.clientWidth;
        });
    </script>
</head>
<body>
        ...
        <div id="myTabContent" class="tab-content">
            ...
            <div class="tab-pane fade" id="details">
                <ul id="iframe" class="nav nav-tabs">
                    ...
                    <li>
                        <a href="#ajpj" data-toggle="tab">案件评价</a>
                    </li>
                </ul>
                <div id="iframeTabContent" class="tab-content">
                    ...
                    <div class="tab-pane fade" id="ajpj">
                        <iframe id="ajpjDetail" src="" style="box-shadow:0 0 10px rgba(0,0,0,0.3)" frameborder="0" scrolling="auto" ></iframe>
                    </div>
                </div>
            </div>
        </div>
