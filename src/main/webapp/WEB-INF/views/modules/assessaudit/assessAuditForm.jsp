...
<form:form id="inputForm" modelAttribute="assessAudit" action="${ctx}/assessaudit/assessAudit/save" method="post"
        ...
        <div class="tab-pane fade in active" id="patient">
            <table class="table-form">
                ...
                <tr>
                    ...
                    <td width="522px">
                        <sys:treeselect id="involveHospital" name="complaintMain.involveHospital" value="${assessAudit.complaintMain.involveHospital}" labelName="" labelValue="${assessAudit.complaintMain.hospital.name}"
            ...
            <table class="table-form">
                <tr style=" " >
                    ...
                    <td style="width: 450px; ">
                        ...
                        <div style="margin-top: -45px;"><sys:ckfinder input="files1" type="files"  uploadPath="/assessAudit/Huan" selectMultiple="true" /></div>
                    </td>
                ...
                <tr style="" >
                    ...
                    <td style="width: 450px; ">
                        <input type="hidden" id="files2" name="files1" htmlEscape="false" class="input-xlarge" value="${files1}" />
                            <%--<form:hidden id="files" path="files" htmlEscape="false" maxlength="255" class="input-xlarge" name="filess" />--%>
                        <div style="margin-top: -45px;"><sys:ckfinder input="files2" type="files"  uploadPath="/assessAudit/Hospital" selectMultiple="true" /></div>
                    </td>
    ...
    <table class="table-form">
        <tr>
            ...
            <td class="tit">地点：</td>
            <td>
                <form:input path="auditAddress" htmlEscape="false" maxlength="200" class="input-xlarge "/>
            </td>
        </tr>
        <tr>
            <td class="tit">医学专家：</td>
            <td>
                <form:input path="medicalExpert" htmlEscape="false" maxlength="32" class="input-xlarge "/>
            </td>
            <td class="tit">日期：</td>
            <td>
        ...
        <tr>
            ...
            <td>
                <form:input path="legalExpert" htmlEscape="false" maxlength="32" class="input-xlarge "/>
            </td>
