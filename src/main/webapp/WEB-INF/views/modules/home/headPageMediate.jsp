...
<body>
<form:form id="searchForm" action="${ctx}/complaintmain/complaintMain/head?type=tj" method="post" class="breadcrumb form-search">
...
<div id="aa" style="width: 100%;margin: 0 auto;background : #ffffff ;background-size:cover;"><%--background-image: url('${ctxStatic}/images/background.jpg');--%>
    ...
    <div id="main1" style="width: 39%; height: 534px;border: 0px;border-style:solid;float: left;margin-left: 0.5%;margin-bottom: -160px;"></div>
    ...
    <div id="bigMain" style="width: 39%;height: 200px;border: 0px;border-style:solid;float: left;margin-left: 0.5%;margin-top: 174px;"></div>
