...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/cms/comment/">"投诉/建议"列表</a></li>
<%--
...
--%>
		<label>"投诉/建议"内容：</label><form:input path="content" htmlEscape="false" maxlength="50" class="input-small"/>&nbsp;
	...
	<table id="contentTable" class="table table-bordered table-condensed">
		<thead><tr><th>"投诉/建议"内容</th><%--<th>文档标题</th>--%><th>发起人</th><th>发起人IP</th><th>发起时间</th><th nowrap="nowrap">操作</th></tr></thead>
		<tbody>
...
--%>
			...
			<tr id="c_${comment.id}" style="background:#fdfdfd;display:none;"><td colspan="6">${fns:replaceHtml2(comment.content)}</td></tr>
		</c:forEach>
		</tbody>
	</table>
