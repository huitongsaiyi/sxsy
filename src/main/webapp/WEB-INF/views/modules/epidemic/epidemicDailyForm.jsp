...
<head>
	...
	<script type="text/javascript">
		...
		function removeCssClass() {
			$('#workSituation').removeClass('required');
			$('#fillingDate').removeClass('required');
		}
		function addCssClass() {
			$('#workSituation').addClass('required');
			$('#fillingDate').addClass('required');
		}
	</script>
</head>
<body>
...
<form:form id="inputForm" modelAttribute="epidemicDaily" action="${ctx}/epidemic/epidemicDaily/save" method="post" class="form-horizontal">
	...
	<fieldset>
			...
			<div class="control-group">
				<div class="controls">
					<table id="contentTable" class="table table-striped table-bordered table-condensed">
						...
						<shiro:hasPermission name="epidemic:epidemicDaily:edit"><tfoot>
						<tr><td colspan="19"><a href="javascript:" onclick="addRow('#egressInfoList', egressInfoRowIdx, egressInfoTpl);egressInfoRowIdx = egressInfoRowIdx + 1;" class="btn">新增</a></td></tr>
					...
					<table id="egressInfoList{{idx}}" class="table table-striped table-bordered table-condensed">
						<tr >
							...
							<td width="15%">
								<input id="egressInfoList{{idx}}_egressName" name="egressInfoList[{{idx}}].egressName" type="text" value="{{row.egressName}}" maxlength="20" class="input-mini "/>
							</td>
							<td class="tit" width="10%"><font color="red">*</font>性别：</td>
							<td width="15%">
								<select id="egressInfoList{{idx}}_egressSex" name="egressInfoList[{{idx}}].egressSex" data-value="{{row.egressSex}}" class="input-mini required">
									<option value=""></option>
							...
							<td width="15%">
									<input id="egressInfoList{{idx}}_egressAge" name="egressInfoList[{{idx}}].egressAge" type="text" value="{{row.egressAge}}" maxlength="4" class="input-mini "/>岁
							</td>
							<td class="tit" width="10%"><font color="red">*</font>关系：</td>
							<td width="15%">
								<select id="egressInfoList{{idx}}_relation" name="egressInfoList[{{idx}}].relation" data-value="{{row.relation}}" class="input-mini required">
									<option value=""></option>
						...
						<tr >
							...
							<td width="15%">
									<input id="egressInfoList{{idx}}_temperature" name="egressInfoList[{{idx}}].temperature" type="text" value="{{row.temperature}}" maxlength="255" class="input-mini "/>℃
							</td>
							<td class="tit" width="10%"><font color="red">*</font>健康状况：</td>
							<td width="15%">
									<input id="egressInfoList{{idx}}_healthCondition" name="egressInfoList[{{idx}}].healthCondition" type="text" value="{{row.healthCondition}}" maxlength="255" class="input-mini "/>
							</td>
							<td class="tit" width="10%"><font color="red">*</font>家庭详细地址：</td>
							<td width="15%" colspan="3">
								<input id="egressInfoList{{idx}}_userAddress" name="egressInfoList[{{idx}}].userAddress" type="text" value="{{row.userAddress}}" maxlength="255" class="input-xxlarge "/>
							</td>
						</tr>
						<tr >
							<td class="tit" width="10%"><font color="red">*</font>是否外出：</td>
							<td width="15%">
								<select id="egressInfoList{{idx}}_isEgress" name="egressInfoList[{{idx}}].isEgress" data-value="{{row.isEgress}}" class="input-mini required">
									<option value=""></option>
							...
							<td width="15%">
									...
									value="{{row.egressTime}}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
							</td>
							<td class="tit" width="10%">外出方式：</td>
							<td width="15%">
									<input id="egressInfoList{{idx}}_egressMode" name="egressInfoList[{{idx}}].egressMode" type="text" value="{{row.egressMode}}" maxlength="255" class="input-mini "/>
							</td>
							<td class="tit" width="10%">车次/航班号：</td>
							<td width="15%">
								<input id="egressInfoList{{idx}}_trainFlight" name="egressInfoList[{{idx}}].trainFlight" type="text" value="{{row.trainFlight}}" maxlength="255" class="input-mini "/>
							</td>
						</tr>
						<tr >
							<td class="tit" width="10%">外出地点：</td>
							<td width="15%">
								<input id="egressInfoList{{idx}}_egressPlace" name="egressInfoList[{{idx}}].egressPlace" type="text" value="{{row.egressPlace}}" maxlength="255" class="input-mini "/>
							</td>
							...
							<td width="15%">
								<input id="egressInfoList{{idx}}_returnTime" name="egressInfoList[{{idx}}].returnTime" type="text" readonly="readonly" maxlength="20" class="input-mini Wdate "
									value="{{row.returnTime}}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
							</td>
							<td class="tit" width="10%">返回方式：</td>
							<td width="15%">
								<input id="egressInfoList{{idx}}_returnMode" name="egressInfoList[{{idx}}].returnMode" type="text" value="{{row.returnMode}}" maxlength="255" class="input-mini "/>
							</td>
							<td class="tit" width="10%">返回地点：</td>
							<td width="15%">
								<input id="egressInfoList{{idx}}_returnPlace" name="egressInfoList[{{idx}}].returnPlace" type="text" value="{{row.returnPlace}}" maxlength="255" class="input-mini "/>
							</td>
						</tr>
					</table>
						//-->
		...
		<table class="table-form">
			...
			<tr >
				<td >
					<form:textarea path="workSituation" rows="3" cssClass="required" style="margin: 0px;  width: 80%;"/>
				</td>
			</tr>
		</table>
		<table class="table-form">
			...
			<tr >
				<td>
					<input id="fillingDate" name="fillingDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate required"
						   value="${epidemicDaily.fillingDate}"
	...
	<div class="form-actions">
		<shiro:hasPermission name="epidemic:epidemicDaily:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存" onclick="$('#workRemark').val('');removeCssClass()"/>&nbsp;</shiro:hasPermission>
		<shiro:hasPermission name="epidemic:epidemicDaily:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="确认完成" onclick="$('#workRemark').val('true');addCssClass()"/>&nbsp;</shiro:hasPermission>
