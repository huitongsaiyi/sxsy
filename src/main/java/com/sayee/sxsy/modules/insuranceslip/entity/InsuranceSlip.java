...
public class InsuranceSlip extends DataEntity<InsuranceSlip> {
	...
	@Length(min=1, max=32, message="投保单ID长度必须介于 1 和 32 之间")
	...
	@Length(min=0, max=32, message="投保人长度必须介于 0 和 32 之间")
	...
	@Length(min=0, max=32, message="投保人：通信地址和邮编长度必须介于 0 和 32 之间")
	...
	@Length(min=0, max=32, message="被保险人长度必须介于 0 和 32 之间")
	...
	@Length(min=0, max=32, message="被保险人地址长度必须介于 0 和 32 之间")
	...
	@Length(min=0, max=32, message="投保区域范围长度必须介于 0 和 32 之间")
	...
	@Length(min=0, max=1, message="投保方式长度必须介于 0 和 1 之间")
