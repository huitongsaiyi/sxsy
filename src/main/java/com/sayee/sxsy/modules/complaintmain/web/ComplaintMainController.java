		...
		if (StringUtils.isNotBlank(newType)){
		    if ("duty".equals(newType)){//责任度
                List<Map<String,Object>> list=new ArrayList<>();
						complaintMainService.findDuty(user,year,beginMonthDate,endMonthDate,type);
                ...
                Map<String,Object> map=new HashMap<>();
						complaintMainService.findAmountRatio(user,year,beginMonthDate,endMonthDate,type);
                map.put("50万及以上","1");
...
//                dList.add(map6);
				...
				List<Map<String, Object>> gradeList = new ArrayList<>();
						complaintMainService.findGrade(user, year, beginMonthDate,endMonthDate,type);
                Map<String,Object> map=new HashMap<>();
