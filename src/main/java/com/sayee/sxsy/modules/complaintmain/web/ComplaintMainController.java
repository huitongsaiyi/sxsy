...
//                Map<String,Object> map=new HashMap<>();
//                map.put("name","三级甲等"); map.put("value","5");
//                Map<String,Object> map1=new HashMap<>();
//                map1.put("name","三级乙等");map1.put("value","16");
//                Map<String,Object> map2=new HashMap<>();
//                map2.put("name","二级甲等");map2.put("value","34");
//                Map<String,Object> map3=new HashMap<>();
//                map3.put("name","二级乙等");map3.put("value","36");
//                Map<String,Object> map4=new HashMap<>();
//                map4.put("name","乡镇卫生院");map4.put("value","42");
//                Map<String,Object> map5=new HashMap<>();
//                map5.put("name","社区服务站");map5.put("value","55");
//                Map<String,Object> map6=new HashMap<>();
//                map6.put("name","民营医院");map6.put("value","10");
//                gradeList.add(map);
//                gradeList.add(map1);
//                gradeList.add(map2);
//                gradeList.add(map3);
